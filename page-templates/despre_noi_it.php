                        ...
                        <div class="about_content position-relative z_99">
                           <div class="title_all_box style_one text-left  dark_color">
                              <div class="title_sections">
                                 <div class="before_title">NOI</div>
                     ...
                     <div class="tab_over_all_box">
                        <div class="tabs_header clearfix">
                           <ul class="showcase_tabs_btns nav-pills nav clearfix">
                              <li class="nav-item">
                                 <a href="/domande-frequenti" class="nav-link active">Domande frequenti</a>
                              </li>
                              <li class="nav-item">
                                 <a href="/politica-di-ritorno" class="nav-link">Politica di ritorno</a>
                              </li>
                              <li class="nav-item">
                                 <a href="/opzioni-di-consegna" class="nav-link">Opzioni di consegna</a>
                              </li>
                              <li class="nav-item">
                                 <a href="/negozio" class="nav-link" >Negozio</a>
                              </li>
                              <li class="nav-item">
                                 <a href="/contatto" class="nav-link">Contatto</a>
                              </li>
                           </ul>
                           <div class="toll_free">
                              <a href="tel:<?php the_field('telefon_contact', 'options'); ?>"> <i class="icon-phone-call"></i>Chiama per i dettagli</a>
                           </div>
                        </div>
