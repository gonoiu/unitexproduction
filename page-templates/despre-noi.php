               ...
               <div class="about_content position-relative z_99">
                  <div class="title_all_box style_one text-left  dark_color">
                     <div class="title_sections">
                        <div class="before_title">Suntem</div>
                  ...
                  <div class="theme_btn_all color_one">
                     <a href="/contact" target="_blank" rel="nofollow" class="theme-btn five">Contact<i
                     ...
                     <div class="tab_over_all_box">
                        <div class="tabs_header clearfix">
                           <ul class="showcase_tabs_btns nav-pills nav clearfix">
                              ...
                              <li class="nav-item">
                                 <a href="/magazin" class="nav-link" >Produse</a>
                              </li>
                              <li class="nav-item">
                           ...
                           <div class="toll_free">
                              <a href="tel:<?php the_field('telefon_contact', 'options'); ?>"> <i class="icon-phone-call"></i>Suna pentru detalii</a>
                           </div>
                        </div>
