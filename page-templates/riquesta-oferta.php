...
<div id="content" class="site-content ">
  ...
  <section class="about-section">
    ...
    $prenumec = htmlspecialchars($_POST['cprenume'], ENT_QUOTES, 'UTF-8');
    $email = $_POST['cemail'];
    ...
    $firma = htmlspecialchars($_POST['cfirma'], ENT_QUOTES, 'UTF-8');
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cnume" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="<?php echo $add_nume; ?>" value="<?php echo $numeclient; ?>" />
                </div>
              </div>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" name="cprenume" placeholder="<?php echo $add_prenume; ?>" value="<?php echo $prenumec; ?>"/>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="firma" name="cfirma" value='<?php echo $persoana_fizica; ?>'
                    placeholder="(<?php echo $optional; ?>)"  value="<?php echo $firma; ?>" />
                </div>
              </div>

              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  <label for="telefon"><?php echo $telefon2; ?></label>
      ...
      <?php
          ...
          unset($_COOKIE['produse_it']);
          setcookie('produse_it', '', time() - 3600, '/');
