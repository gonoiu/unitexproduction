      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               ...
               <?php if(have_rows('informatii_en', 'options')):?>
                  <?php while(have_rows('informatii_en', 'options')): the_row();
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">Free shipping</a></h2>
                           <p>Depending on the quantity purchased</p>
                        </div>
                     </div>
                  </div>
                  <!--===============spacing==============-->
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2> <a href="#" target="_blank" rel="nofollow">Free return</a></h2>
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">Secure Payments</a></h2>
                           <p>Safe shopping</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">+ 2500 Products</a></h2>
                           <p>Have you got all you require</p>
                        </div>
                     </div>
                  </div>
                  <!--===============spacing==============-->
      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                     <h2><?php the_field('titlu_chingi_ancorare'); ?></h2>
                  </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
               ...
               <div class="col-lg-12">
                  <div class="title_all_box style_one text-center dark_color">
                     <div class="title_sections">
                        ...
                        <h2 class="title">Ask for a price offer for the desired products</h2>
                     </div>
                     <!--===============spacing==============-->
                                                ...
                                                <div class="product_box type_three">
                                                   <div class="inner_box">
                                                      ...
                                                      <div class="image_box">
                                                         ...
                                                         <div class="cart_btn">
                                                            <a href="<?php echo $post_item['guid'] ?>" class="button add_to_cart_button">Request offer</a>
                                                         </div>
                                                      </div>
                                                   </div>
      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                     <h2><?php the_field('titlu_chingi_circulare_tubulare'); ?></h2>
                  </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
            ...
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                        ...
                        <h2 class="title">You can also find us in...</h2>
                     </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                     <h2><?php the_field('titlu_chingi_plate_cu_urechi'); ?></h2>
                  </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
