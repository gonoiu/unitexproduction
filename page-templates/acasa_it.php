      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               ...
               <?php if(have_rows('informatii_it', 'options')):?>
                  <?php while(have_rows('informatii_it', 'options')): the_row();
               ...
               <div class="col-xl-6 col-lg-12">
                  <div class="title_all_box style_one dark_color">
                     <div class="title_sections ">
                        ...
                        <h2><?php the_field('slogan_it', 'options'); ?></h2>
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">Spedizione gratuita</a></h2>
                           <p>A seconda della quantità acquistata</p>
                        </div>
                     </div>
                  </div>
                  <!--===============spacing==============-->
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2> <a href="#" target="_blank" rel="nofollow">Reso gratuito</a></h2>
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">Pagamenti sicuri</a></h2>
                           <p>Acquisti sicuri</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xl-3 col-lg-6 col-sm-12 col-md-6">
                  <div class="icon_box_all style_seven">
                     <div class="icon_content">
                        ...
                        <div class="text_box">
                           <h2><a href="#" target="_blank" rel="nofollow">2500 Prodotti</a></h2>
                           <p>Hai tutto ciò di cui hai bisogno</p>
                        </div>
                     </div>
                  </div>
                  <!--===============spacing==============-->
      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                     <h2>Bloccaggio del Carico / Sistemi Ancoraggio</h2>
                  </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
               ...
               <?php if( the_field('link_chingi_ancorare') ): ?>
                  <div class="theme_btn_all color_two text-center">
                     <a href="<?php the_field('link_chingi_ancorare')?>" target="_blank" rel="nofollow" class="theme-btn two">Vedi i prodotti</a>
                  </div>
               <?php endif; ?>
            </div>
         </div>
               ...
               <div class="col-lg-12">
                  <div class="title_all_box style_one text-center dark_color">
                     <div class="title_sections">
                        ...
                        <h2 class="title">Richiedi un'offerta di prezzo per i prodotti desiderati</h2>
                     </div>
                     <!--===============spacing==============-->
                              ...
                              <div class="product_box type_three">
                                 <div class="inner_box">
                                    ...
                                    <div class="image_box">
                                       ...
                                       <div class="cart_btn">
                                          <a href="<?php echo $post_item['guid'] ?>" class="button add_to_cart_button">Richiedi l'offerta</a>
                                       </div>
                                    </div>
                                 </div>
      ...
      <section class="service-section-one bg_light_1">
         ...
         <div class="container">
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                     <h2>Cinghie circolari tubolari</h2>
                  </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
               ...
               <?php if( the_field('chingi_circulare_tubulare') ): ?>
                  <div class="theme_btn_all color_two text-center">
                     <a href="<?php the_field('chingi_circulare_tubulare'); ?>" target="_blank" rel="nofollow" class="theme-btn two">Vedi i prodotti</a>
                  </div>
               <?php endif; ?>   
            </div>
         </div>
            ...
            <div class="row">
               <div class="title_all_box style_one text-center dark_color">
                  <div class="title_sections">
                        ...
                        <h2 class="title">Ci trovi anche a...</h2>
                     </div>
                  <!--===============spacing==============-->
                     <div class="pd_bottom_20"></div>
                  <!--===============spacing==============-->
         ...
         <div class="container">
            <div class="row">
               ...
               <?php if( the_field('chingi_plate_cu_urechi') ): ?>
                  <div class="theme_btn_all color_two text-center">
                     <a href="<?php the_field('chingi_plate_cu_urechi'); ?>" target="_blank" rel="nofollow" class="theme-btn two">Vedi i prodotti</a>
                  </div>
               <?php endif; ?>   
            </div>
         </div>
