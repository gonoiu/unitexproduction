            ...
            <div class="inner_stell">
               <div class="row">
                  <div class="col-md-12">
                     <div class="content">
                        <h2>
                           <?php the_field('titlu_colaboreaza_it', 'options'); ?>
                        </h2>
                        <p>
                           <?php the_field('descriere_colaboreaza_it', 'options'); ?>
                        </p>
                     </div>
                     <div class="theme_btn_all color_two">
                        <a href="/contact_it" rel="nofollow" class="theme-btn two">Contatto</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="footer_widgets about_company light_color">
                  <div class="about_company_inner">
                     ...
                     <div class="content_box">
                        <p>
                           <?php
                           $colaboreaza = get_field('descriere_colaboreaza_it', 'options');
                     ...
                     <div class="navigation_foo_box">
                        <div class="navigation_foo_inner">
                           <div class="menu-information-container">
                              <ul class="menu">
                                 <li class="menu-item"><a href="/frequent-questions">Domande frequenti</a></li>
                                 <li class="menu-item"><a href="/delivery-options">Opzioni di consegna</a></li>
                                 <li class="menu-item"><a href="/return-policy">Politica di ritorno</a></li>
                                 <li class="menu-item"><a href="/cookie-policy">Gestione dei Cookie</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="navigation_foo_inner">
                        <ul class="menu">
                           ...
                           foreach ($categories as $category) {
                              if($category->name !== "Non categorizzato"){
            ...
            <div class="row align-items-center">
               <div class="col-lg-8 col-md-12 col-sm-12">
                  <div class="footer_copy_content">
                     Copyright &copy;
                     <?php echo date('Y'); ?>
                     <?php the_field('companie', 'options'); ?>. Tutti i diritti riservati.
                  </div>
               </div>
               <div class="col-lg-4 col-md-12 col-sm-12">
                  <div class="nav_link_v_one text-md-end">
                     <ul>
                        <li>
                           <a href="/terms-and-conditions" rel="nofollow">Termini e Condizioni</a>
                        </li>
                        <li>
                           <a href="/privacy-policy" rel="nofollow">Politica sulla riservatezza</a>
                        </li>
                     </ul>
                  </div>
               </div>
   ...
   <div class="crt_mobile_menu">
      ...
      <nav class="menu-box">
         ...
         <form role="search" method="get" action="#">
            <input type="search" class="search" placeholder="Cercare..." value="" name="s" title="Cerca nel sito" />
   ...
   <div id="search-popup" class="search-popup">
      ...
      <div class="popup-inner">
         ...
         <div class="search-form">
            <fieldset>
               <form role="search" method="get" action="#">
                  <input type="search" class="search" placeholder="Cercare..." value="" name="s"
                     ...
                     <form class="contact-form" method="post" action="sendemail.php">
                        <p><label> Nome / Azienda<br />
                              <input type="text" name="name" value="" size="40" aria-required="true"
                                 aria-invalid="false" placeholder="Inserisci Nome / Azienda" />
                              <br />
                        ...
                        <p><label> E-mail<br />
                              <input type="email" name="email" value="" size="40" aria-required="true"
                                 aria-invalid="false" placeholder="Inserisci l'email" />
                              <br />
                        ...
                        <p><label> Telefono<br />
                              <input type="number" name="phone" value="" size="40" aria-required="true"
                                 aria-invalid="false" placeholder="Inserisci il telefono" />
                              <br />
                        ...
                        <p>
                           <label> Argomento<br />
                              <input type="text" name="subject" value="" size="40" aria-required="true"
                                 aria-invalid="false" placeholder="Argomento" />
                              <br />
                        ...
                        <p>
                           <label> Messaggio<br />
                              <textarea name="message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea"
                                 aria-invalid="false" placeholder="Scrivi un messaggio"></textarea>
                              <br />
                              <i class="fa fa-comments"></i><br />
                           </label>
                        </p>
                        <p><input type="submit" value="Invia una email" /></p>
                     </form>
                  </div>
               </div>
               <div class="col-lg-7 col-md-12 about_company_inner">
                  <div class="abt_content">
                     ...
                     <div class="text">
                        ...
                        <a href="/about-us">Per saperne di più...</a>
                     </div>
                     <div class="post_contet_modal">
                        ...
                        <div class="post_enable">
                           <div class="modal_post_grid">
                              <a href="#">
                                 <img width="852" height="812"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/blog/blog-image-9.jpg"
                           ...
                           <div class="modal_post_grid">
                              <a href="#">
                                 <img width="852" height="812"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/blog/blog-image-8.jpg"
                                    class="main_img wp-post-image" alt="img" />
                              </a>
                           </div>
                           <div class="modal_post_grid">
                              <a href="#">
                                 <img width="852" height="812"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/blog/blog-image-7.jpg"
                                    class="main_img wp-post-image" alt="img" />
                              </a>
                           </div>
                           <div class="modal_post_grid">
                              <a href="#">
                                 <img width="852" height="812"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/blog/blog-image-6.jpg"
                                    class="main_img wp-post-image" alt="img" />
                              </a>
                           </div>
                           <div class="modal_post_grid">
                              <a href="#">
                                 <img width="852" height="812"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/assets/images/blog/blog-image-5.jpg"
                                    class="main_img wp-post-image" alt="img" />
                              </a>
                           </div>
                        </div>
               ...
               <div class="widget_shopping_cart_content">
                  <p class="woocommerce-mini-cart__empty-message">
                     ...
                     if (isset($_COOKIE['produse_it'])) {
                        ...
                        echo "<form action='/wp/it/richiesta-di-offerta-2/' method='post'>";
                        ...
                        if ($obj) {
                           foreach ($obj as $item => $value) {
                              ...
                              echo "<p>" . "- " . $value->nume . "-" . $value->cantitate . "buc" . "<a href='elimina-prodotto?id={$value->cod}' title='Elimina dal carrello'> [ x ]</a></p>";
                              echo "<hr/>";
                              $i++;
                        ...
                        if ($i == 0) {
                           ...
                           ?>
                       Non hai prodotti selezionati per la <br /><strong>Richiesta di offerta</strong><br /> Vai al <a
                           href="/wp/it/negozio">Negozio prodotti</a>

                           <?php
                        } else {
                           echo "<input type='submit' name='csubmit' class='btn btn-primary' value='Richiedi offerta'></form>";
